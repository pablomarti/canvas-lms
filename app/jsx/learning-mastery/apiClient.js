...
const rollupsUrl = (course, exclude, page, sortField, sortAsc) => {
  ...
  return `/api/v1/courses/${course}/outcome_rollups?rating_percents=true&per_page=20&include[]=outcomes&include[]=users&include[]=outcome_paths&include[]=outcomes_results${excluding}&page=${page}${sortParams}${sectionParam}`
}
